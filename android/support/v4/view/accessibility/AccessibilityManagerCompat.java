...
public class AccessibilityManagerCompat {
    ...
    static class AccessibilityManagerIcsImpl extends AccessibilityManagerStubImpl {
        ...
        class C02221 implements AccessibilityStateChangeListenerBridge {
            final /* synthetic */ AccessibilityStateChangeListenerCompat val$listener;

            C02221(AccessibilityStateChangeListenerCompat accessibilityStateChangeListenerCompat) {
        ...
        public Object newAccessiblityStateChangeListener(AccessibilityStateChangeListenerCompat listener) {
            return AccessibilityManagerCompatIcs.newAccessibilityStateChangeListener(new C02221(listener));
        }
