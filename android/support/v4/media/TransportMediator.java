...
public class TransportMediator extends TransportController {
    ...
    class C00132 implements Callback {
        C00132() {
        }
    ...
    class C02161 implements TransportMediatorCallback {
        C02161() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C02161();
        this.mKeyEventCallback = new C00132();
