...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00141 implements OnWindowAttachListener {
        C00141() {
        }
    ...
    class C00152 implements OnWindowFocusChangeListener {
        C00152() {
        }
    ...
    class C00174 implements OnAudioFocusChangeListener {
        C00174() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00141();
        this.mWindowFocusListener = new C00152();
        this.mMediaButtonReceiver = new C00163();
        this.mAudioFocusChangeListener = new C00174();
        this.mPlayState = 0;
