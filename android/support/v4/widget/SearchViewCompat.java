...
public class SearchViewCompat {
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class C02251 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListenerCompat val$listener;

            C02251(OnQueryTextListenerCompat onQueryTextListenerCompat) {
        ...
        class C02262 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListenerCompat val$listener;

            C02262(OnCloseListenerCompat onCloseListenerCompat) {
        ...
        public Object newOnQueryTextListener(OnQueryTextListenerCompat listener) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new C02251(listener));
        }
        ...
        public Object newOnCloseListener(OnCloseListenerCompat listener) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new C02262(listener));
        }
