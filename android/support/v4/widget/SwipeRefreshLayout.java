...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C00501 extends Animation {
        C00501() {
        }
    ...
    class C00512 extends Animation {
        C00512() {
        }
    ...
    class C02273 extends BaseAnimationListener {
        C02273() {
            super(null);
        }
    ...
    class C02284 extends BaseAnimationListener {
        C02284() {
            super(null);
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mAnimateToStartPosition = new C00501();
        this.mShrinkTrigger = new C00512();
        this.mReturnToStartPositionListener = new C02273();
        this.mShrinkAnimationListener = new C02284();
        this.mReturnToStartPosition = new C00525();
        this.mCancel = new C00536();
