...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00101 implements ThreadFactory {
    ...
    class C00113 extends FutureTask<Result> {
        C00113(Callable x0) {
            super(x0);
        }
    ...
    class C02152 extends WorkerRunnable<Params, Result> {
        C02152() {
            super();
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C02152();
        this.mFuture = new C00113(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00124.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
