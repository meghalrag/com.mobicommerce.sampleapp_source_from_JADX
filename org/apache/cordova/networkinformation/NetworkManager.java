...
public class NetworkManager extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) {
        ...
        String connectionType = BuildConfig.VERSION_NAME;
        try {
            connectionType = getConnectionInfo(info).get("type").toString();
    ...
    private JSONObject getConnectionInfo(NetworkInfo info) {
        ...
        String extraInfo = BuildConfig.VERSION_NAME;
        if (info != null) {
            if (info.isConnected()) {
                type = getType(info);
            } else {
