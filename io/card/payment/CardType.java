...
public enum CardType {
    ...
    static {
        ...
        f800b = hashMap;
        hashMap.put(m725a("34", null), AMEX);
        f800b.put(m725a("37", null), AMEX);
        f800b.put(m725a("3528", "3589"), JCB);
        f800b.put(m725a("4", null), VISA);
        f800b.put(m725a("51", "55"), MASTERCARD);
        f800b.put(m725a("6011", null), DISCOVER);
        f800b.put(m725a("622126", "622925"), DISCOVER);
        f800b.put(m725a("644", "649"), DISCOVER);
        f800b.put(m725a("65", null), DISCOVER);
        for (Entry entry : f800b.entrySet()) {
            f799a = Math.max(f799a, ((String) ((Pair) entry.getKey()).first).length());
            if (((Pair) entry.getKey()).second != null) {
                f799a = Math.max(f799a, ((String) ((Pair) entry.getKey()).second).length());
            }
        }
    }
    ...
    private static Pair m725a(String str, String str2) {
        Object obj;
        if (str2 == null) {
            obj = str;
        }
    ...
    public static CardType fromCardNumber(String str) {
        ...
        for (Entry entry : f800b.entrySet()) {
            ...
            int i = Integer.parseInt(str.substring(0, min)) < Integer.parseInt(str2.substring(0, min)) ? 0 : Integer.parseInt(str.substring(0, min2)) > Integer.parseInt(str3.substring(0, min2)) ? 0 : 1;
            if (i != 0) {
    ...
    public final String getDisplayName(String str) {
        switch (C0152S.f852a[ordinal()]) {
            case CursorAdapter.FLAG_AUTO_REQUERY /*1*/:
                return ao.m802a(ap.CARDTYPE_AMERICANEXPRESS, str);
            case CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER /*2*/:
                return ao.m802a(ap.CARDTYPE_DISCOVER, str);
            case FragmentManagerImpl.ANIM_STYLE_CLOSE_ENTER /*3*/:
                return ao.m802a(ap.CARDTYPE_JCB, str);
            case TransportMediator.FLAG_KEY_MEDIA_PLAY /*4*/:
                return ao.m802a(ap.CARDTYPE_MASTERCARD, str);
            case FragmentManagerImpl.ANIM_STYLE_FADE_ENTER /*5*/:
                return ao.m802a(ap.CARDTYPE_VISA, str);
            default:
                return null;
        }
    }
    ...
    public final Bitmap imageBitmap(Context context) {
        ...
        return str != null ? C0150O.m745c(str, context) : null;
    }
